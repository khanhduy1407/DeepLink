...
import tk.nkduy.deeplink.DeepLinkMatchResult;
import tk.nkduy.deeplink.MatchType;
import tk.nkduy.deeplink.NodeMetadata;
import tk.nkduy.deeplink.DeepLinkEntry;
import tk.nkduy.deeplink.UrlElement;
 ...
 * </tr>
 * <tr>
 *   <td>{@linkplain tk.nkduy.deeplink.NodeMetadata} e.g. scheme, authority, path segment,
 *     transformation</td>
...
public class MatchIndex {
  ...
  /**
   * Match a given {@link tk.nkduy.deeplink.DeepLinkUri} (given as a List of
  ...
  private CompareResult compareComponentParam(
    ...
    if ((
        //Per tk.nkduy.deeplink.DeepLinkEntryTest.testEmptyParametersNameDontMatch
        ...
        //Per tk.nkduy.deeplink.DeepLinkEntryTest.testEmptyPathPresentParams
