...
import tk.nkduy.deeplink.base.Utils.toByteArrayMap
...
open class BaseDeepLinkDelegate @JvmOverloads constructor(
    ...
    private fun deepLinkHandlerInstance(handlerClazz: Class<*>): tk.nkduy.deeplink.handler.DeepLinkHandler<Any> =
        try {
        ...
        } as tk.nkduy.deeplink.handler.DeepLinkHandler<Any>
        ...
        return handlerClazz.genericInterfaces.filterIsInstance<ParameterizedType>()
            .singleOrNull {
                (it.rawType as Class<*>).canonicalName.startsWith(
                    tk.nkduy.deeplink.handler.DeepLinkHandler::class.java.name
                )
