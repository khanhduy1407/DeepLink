...
-keep class * implements tk.nkduy.deeplink.handler.DeepLinkHandler {
...
-keep interface tk.nkduy.deeplink.handler.DeepLinkHandler
...
-if class * extends tk.nkduy.deeplink.handler.DeepLinkHandler {
...
-keepclasseswithmembers class * {
    @tk.nkduy.deeplink.DeepLink <methods>;
}
